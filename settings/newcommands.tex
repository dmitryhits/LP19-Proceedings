...
\DeclareDocumentCommand{\nicetab}{m m O{nocap} O{nolab}}{
    \begin{table}[ht!]\centering\setlength\extrarowheight{2pt}\alternatecolors\begin{tabular}{#1}\rowcolor{darkgray!30}\tline{.5} #2\tline{.5}\end{tabular}\caplab{#3}{#4}\end{table}}
